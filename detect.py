...
def uet_detect():
    ...
    # 加载模型
    net.load_state_dict(torch.load('SAVE/Unet40.pt'))
    net.eval()
    # 预测
    img_out = net(img)
    ...
    return imgt, area, (www, hhh)


imgt, area, imgsize = uet_detect()
